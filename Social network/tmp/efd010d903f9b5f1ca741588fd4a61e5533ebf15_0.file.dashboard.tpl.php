<?php
/* Smarty version 3.1.33, created on 2019-04-04 14:39:24
  from 'C:\xampp\htdocs\Social network - final\faza4 - Sandra\views\dashboard.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ca5fafc111019_80887824',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'efd010d903f9b5f1ca741588fd4a61e5533ebf15' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Social network - final\\faza4 - Sandra\\views\\dashboard.tpl',
      1 => 1554381561,
      2 => 'file',
    ),
  ),
...
function content_5ca5fafc111019_80887824 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
...
<div id="cc_userdata" class="picture">
    <span><img  src="img/<?php echo $_smarty_tpl->tpl_vars['postsRows']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['username'];?>
.jpg"></span>
    <div class="text">
...
echo $_smarty_tpl->tpl_vars['postsRows']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['lastname'];?>
</section>
...
/*
   function stampajJSON(data){
     var gogo = JSON.parse(data);
   document.getElementById("cc_insertdata").innerHTML='';
   for(let i=0;i<gogo.length;i++){
        document.getElementById("cc_insertdata").innerHTML += "<br>" + gogo[i].name ;
        console.log(gogo[i].name);
    }
  }
  */
  function prikazEksternogFajla(postid) {
    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
        //document.getElementById("cc_insertdata").innerHTML += "<br>" + 'dobar dan';
